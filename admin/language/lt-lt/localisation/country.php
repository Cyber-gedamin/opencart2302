...
// Help
$_['help_address_format']     = 'Vardas = {firstname}<br />Pavardė = {lastname}<br />Įmonė = {company}<br />Adresas = {address_1}<br />Adresas (papildomas) = {address_2}<br />Miestas = {city}<br />Pašto kodas = {postcode}<br />Zona = {zone}<br />Zonos kodas = {zone_code}<br />Šalis = {country}';
