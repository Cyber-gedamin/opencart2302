    ...
    <div class="heading">
      <div class="row">
        ...
        <div class="col-md-8 text-right">
          ...
          <a onclick="editDefaultProduct()" class="btn btn-info default-product" href="index.php?route=catalog/product/edit&token=<?php echo $token; ?>&product_id=-1" data-toggle="tooltip" title="<?php echo $edit_default_product;?>"><i class="fa fa-pencil-square-o"></i></a>
...
<?php if(!isset($ajaxed)){?>
  ...
  $(document).ready(function($) {
    ...
    $(document).on('click', '#product-extra-wrapper .copy-default-product', function(e){
      e.preventDefault();
      jQuery.get('index.php?route=catalog/product_extra/default_product&token='+token, function(result){
        jQuery.post('index.php?route=catalog/product/copy&token='+token, {selected: [-1]}, function(result){
